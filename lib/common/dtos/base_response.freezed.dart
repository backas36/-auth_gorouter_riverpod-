...
@JsonKey(name: 'status') String get status;@JsonKey(name: 'data') T get data;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BaseResponse<T>&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.data, data));
}
...
@override
String toString() {
  return 'BaseResponse<$T>(status: $status, data: $data)';
}
...
@useResult
$Res call({
@JsonKey(name: 'status') String status,@JsonKey(name: 'data') T data
});
...
class _BaseResponse<T> implements BaseResponse<T> {
  const _BaseResponse({@JsonKey(name: 'status') required this.status, @JsonKey(name: 'data') required this.data});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BaseResponse<T>&&(identical(other.status, status) || other.status == status)&&const DeepCollectionEquality().equals(other.data, data));
}
